...
pub use slash::{
    ...
    format_trace, format_transcript, parse_input, slash_command_exact, slash_command_matches,
    InputCommand, SlashCommand, SlashCommandInfo, SlashInvocation, SLASH_COMMANDS,
};
